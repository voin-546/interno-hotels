...
const ContactPage = () => {
    return (
        <>
            <Helmet>
                <meta property="og:site_name" content="Contact Interno"/>
            ...
            <section className="contact-hero">
                <div className="text">
                    ...
                    <p data-aos="fade-up" data-aos-delay="300">Home / Contact</p>
                </div>
            </section>
            <section className="contact-flex">
                <div className="text-center">
                    <h1 data-aos="fade-up">We love meeting new people and helping them.</h1>
                </div>
                    ...
                    <div className="submenu">
                        <a href="#!">
                            <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 52 52" fill="none">
                                ...
                                <path d="M34.8846 18H17.1154C15.9471 18 15 18.9514 15 20.125V32.875C15 34.0486 15.9471 35 17.1154 35H34.8846C36.0529 35 37 34.0486 37 32.875V20.125C37 18.9514 36.0529 18 34.8846 18Z" stroke="#CDA274" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M18 21L26 28L34 21" stroke="#CDA274" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                            <p>info@interno.com</p>
                        </a>
                        <a href="tel:+1 (378) 400-1234">
                            <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 52 52" fill="none">
                                <circle cx="26" cy="26" r="26" fill="white" />
